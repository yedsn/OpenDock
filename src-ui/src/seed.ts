...
export function createSeedData(): AppData {
  return {
    ...
    settings: {
      general: { defaultView: "全部资源", recentLimit: 12, confirmBeforeOpen: true, logOpenFailures: true, openWebInNewWindow: true, closeWindowAfterOpen: false, language: "简体中文", autoSnapshotIntervalMinutes: 60, autoSnapshotKeepCount: 7, autoStart: false, startMinimized: false },
